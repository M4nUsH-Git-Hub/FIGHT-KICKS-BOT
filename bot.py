...
async def fetch_sneaker_by_sku(sku: str) -> dict | None:
    """Cerca un prodotto su StockX tramite SKU. Restituisce i dati o None."""
    import aiohttp
    api_key = os.environ.get("RAPIDAPI_KEY")
    if not api_key:
        return None

    url = "https://stockx15.p.rapidapi.com/fetch_product_data/"
    headers = {
        "x-rapidapi-host": "stockx15.p.rapidapi.com",
